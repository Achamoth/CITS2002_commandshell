...
extern int countDirs(char *path); // in execute.c
int executeCommand(char **argv, char *infile, char *outfile, bool append, bool pipe_out, bool pipe_in, int npipe); //in execute.c
extern void path_split(char *path); //in executable.c
extern void childSignalHandler(); //in executable.c
extern int npipe; //in executable.c
extern int pfd[100][2]; //in executable.c
extern bool previous_type_was_pipe; //in executable.c
